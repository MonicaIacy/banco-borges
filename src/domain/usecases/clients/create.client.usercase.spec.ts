...
const ClientRepositoryMock = ClientsRepository as jest.Mock<ClientsRepository>;

test("Teste unitário CreateClientUsecase", async() => {

    const clientRepository = new ClientRepositoryMock() as jest.Mocked<ClientsRepository>;
